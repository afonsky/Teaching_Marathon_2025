...
### <u>Алексей Болдырев</u>, Максим Карпов, Олег Мельников<br><br>
#### ВШЭ 14/02/2025
...
# Машинное обучение<br> = подбор функций
...
<div>
<figure>
  <img src="/curve_fitting_2x.png" style="width: 336px !important; position:relative; top: -134px; left: 63px">
</figure>
</div>
</div>
...
## Примеры соревновательных задач из курсов<br> машинного и глубинного обучения<br> на ПАД ФКН и МИЭФ
...
# Особенности организации соревнований
...
* Вместе с условиями соревнования мы предлагаем студентам:
  ...
  2. **Стартовые идеи**:
      * Наводящие вопросы;
      * Ссылки на исследования, посвященные похожей задаче.
...
* В **Kaggle**:
  * Преподаватель настраивает соревнование (набор данных, правила оценивания, дедлайны, количество участников в командах, количество посылок решений в день)
...
<div>
<figure>
<img src="/LB.png" style="width: 400px !important;">
</figure>
</div>
<div>
<br>

* Всем студентам команды выставляется одинаковая оценка согласно квартилю в приватной турнирной таблице
...
* Позволяет развивать *hard* и *soft* skills студентов
